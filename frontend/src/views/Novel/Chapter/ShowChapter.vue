...
export default {
  ...
  methods: {
    getDeatailChapter() {
      axios
        .get(`http://3.84.45.245:3000/novel/chapter/showChapter/${this.$route.params.chapter_id}/${this.$route.params.novel_id}`)
    ...
    getChapterList(){
      axios
      .get(`http://3.84.45.245:3000/novel/chapter/showChapter/${this.$route.params.novel_id}`)
      .then((res) => {
