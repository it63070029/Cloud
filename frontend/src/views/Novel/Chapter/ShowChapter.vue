...
export default {
  ...
  methods: {
    getDeatailChapter() {
      axios
        .get(`${this.$hostname}/novel/chapter/showChapter/${this.$route.params.chapter_id}/${this.$route.params.novel_id}`)
    ...
    getChapterList(){
      axios
      .get(`${this.$hostname}/novel/chapter/showChapter/${this.$route.params.novel_id}`)
      .then((res) => {
