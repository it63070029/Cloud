...
export default {
  ...
  methods: {
    getShelfBooks() {
      axios
        .get(`http://localhost:3000/${this.$route.params.user_id}`)
        .then((res) => {
    ...
    //         console.log("555")
    //         axios
    //         .get(`http://localhost:3000/${this.shelfBooks[i].novel_id}`)
    //         .then((res) => {
    //             this.novelsShelf = res.data.novelsShelf;
    //         })
    //         .catch((err) => {
    ...
    deleteBook(novel_id){
        ...
        axios
        .delete(`http://localhost:3000/${this.users.user_id}/${novel_id}`)
        .then((res) => 
