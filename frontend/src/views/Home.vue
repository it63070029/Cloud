...
export default {
  ...
  methods: {
    ...
    getShelfBooks() {
      axios
        .get(`${this.$hostname}/${this.users.user_id}`)
        .then((res) => {
    ...
    addLike(novel_id) {
      if (this.users != null) {
        axios
          .put(
            `${this.$hostname}/novel/addlike/${novel_id}/${this.users.user_id}`
          )
          .then((response) => {
    ...
    addView(novel_id) {
      axios
        .put(
          `${this.$hostname}/novel/addview/${novel_id}/${this.users.user_id}`
        )
        .then((response) => {
          let selectedNovel = this.novels.filter(
            (e) => e.novel_id === novel_id
